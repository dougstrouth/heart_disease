...
def interpret_model(model_pipeline, X_train_processed, feature_names):
    ...
    if model_pipeline is None:
        logger.error("Cannot interpret: Model pipeline is None.")
        return None
    ...
    if hasattr(classifier, 'feature_importances_'):
        ...
        logger.info(feature_importances_df.head(10))
        ...
        try:
            ...
            logger.error(f"Error generating SHAP plots for tree model: {e}")
        ...
        logger.info(feature_coefficients_df.head(10))
        ...
        try:
            ...
            logger.error(f"Error generating SHAP plots for linear model: {e}")

        return feature_coefficients_df

    else:
        logger.warning("Model does not have feature importances or coefficients. Consider SHAP/LIME.")
        return None
